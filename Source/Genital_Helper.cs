...
namespace rjw
{
    static class Genital_Helper
    {
        ...
        {
            BodyPartRecord anusPart = pawn.RaceProps.body.AllParts.Find((BodyPartRecord bpr) => String.Equals(bpr.def.defName, "Anus"));
        ...
        public static bool breasts_blocked(Pawn pawn) {
            if (pawn.apparel != null)
                foreach (var app in pawn.apparel.WornApparel) {
                    var gear_def = app.def as bondage_gear_def;
                    if ((gear_def != null) && (gear_def.blocks_breasts))
                        return true;
                }
            return false;
        }
        ...
        public static bool anus_blocked( Pawn pawn)
        {
            if (pawn.apparel != null)
                ...
                {
                    var gear_def = app.def as bondage_gear_def;
                    if ((gear_def != null) && (gear_def.blocks_anus))
                        return true;
                }
            return false;
        }
        ...
        public static bool is_sexualized (Pawn pawn)
		{
            ...
            /*
           bool has_genitals = pawn.health.hediffSet.hediffs.Any((Hediff hed) =>
                                                 (hed.Part == genitalPart) &&
                                                 (((hed as Hediff_Implant) != null) || ((hed as Hediff_AddedPart) != null)) &&
                                                 (hed.def != dummy_privates_initializer));

           bool has_breasts = pawn.health.hediffSet.hediffs.Any((Hediff hed) =>
                                                  (hed.Part == breastsPart) &&
                                                  (((hed as Hediff_Implant) != null) || ((hed as Hediff_AddedPart) != null)) &&
                                                  (hed.def != dummy_privates_initializer));

           bool has_anus = pawn.health.hediffSet.hediffs.Any((Hediff hed) =>
                                      (hed.Part == anusPart) &&
                                      (((hed as Hediff_Implant) != null) || ((hed as Hediff_AddedPart) != null)) &&
                                      (hed.def != dummy_privates_initializer));
           */
    ...
    public static void inject_genitals (BodyDef target)
        ...
        public static void inject_anus(BodyDef target)
        {
            ...
            if (tor_rec != null)
            {
                ...
                var gen_rec = new BodyPartRecord();
                gen_rec.def = DefDatabase<BodyPartDef>.GetNamed("Anus");
                gen_rec.height = BodyPartHeight.Bottom;
                gen_rec.depth = BodyPartDepth.Outside;
                gen_rec.coverage = 0.02f;
                gen_rec.groups.Add(BodyPartGroupDefOf.Torso);
